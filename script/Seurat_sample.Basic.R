...
write.table (sample.cluster@meta.data, file = paste(c(basic.path, "meta.data..cluster.xls"), collapse=""), col.names=TRUE, row.names=FALSE, quote=FALSE, sep="\t")
write.table (sample.cluster@scale.data, file = paste(c(basic.path, "scale.data.cluster.xls"), collapse=""), col.names=TRUE, row.names=FALSE, quote=FALSE, sep="\t")
